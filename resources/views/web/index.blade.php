                    ...
                    <div class="featured-item">
                        <div class="images overflow-hidden">
                            <img src="{{ $category?->thumbnail }}" alt=""
                                class="object-fit-contain h-100 ratio ratio-1x1">
                        </div>
                        <div class="text">
                            <h2><a style="font-size: 16px !important;" href="{{ route('shop') }}">{{ $category?->name }}</a></h2>
                        </div>
                    </div>
                @endforeach
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('shop') }}">Wireless Headphones</a></h2>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('shop') }}">Blue Bag with Lock</a></h2>
                                <div class="rating-product">
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('shop') }}">Stylish Pink Top</a></h2>
                                <div class="rating-product">
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('shop') }}">Brown Com Boots</a></h2>
                                <div class="rating-product">
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('shop') }}">Winter Sweter</a></h2>
                                <div class="rating-product">
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('shop') }}">Blue Kids Shoes</a></h2>
                                <div class="rating-product">
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('shop') }}">Stylish Bag</a></h2>
                                <div class="rating-product">
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            ...
                            <div class="text">
                                <h2><a href="{{ route('shop') }}">Finger Rings</a></h2>
                                <div class="rating-product">
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
                                    <i class="fi flaticon-star"></i>
        ...
        <div class="container">
            ...
            <div class="trendin-slider owl-carousel">
                <div class="product-item">
                    ...
                    <div class="text">
                        <h2><a href="{{ route('shop') }}">Pink Baby Shoes</a></h2>
                        <div class="rating-product">
                            <i class="fi flaticon-star"></i>
                            <i class="fi flaticon-star"></i>
                            <i class="fi flaticon-star"></i>
                ...
                <div class="product-item">
                    ...
                    <div class="text">
                        <h2><a href="{{ route('shop') }}">Earrings</a></h2>
                        <div class="rating-product">
                            <i class="fi flaticon-star"></i>
                            <i class="fi flaticon-star"></i>
                            <i class="fi flaticon-star"></i>
                ...
                <div class="product-item">
                    ...
                    <div class="text">
                        <h2><a href="{{ route('shop') }}">Stylish Pink Bag</a></h2>
                        <div class="rating-product">
                            <i class="fi flaticon-star"></i>
                            <i class="fi flaticon-star"></i>
                            <i class="fi flaticon-star"></i>
                ...
                <div class="product-item">
                    ...
                    <div class="text">
                        <h2><a href="{{ route('shop') }}">Orange Top</a></h2>
                        <div class="rating-product">
                            <i class="fi flaticon-star"></i>
                            <i class="fi flaticon-star"></i>
                            <i class="fi flaticon-star"></i>
                    ...
                    <div class="highlight-wrap">
                        ...
                        @foreach ($recentlyAdd as $product)
                            <div class="product-card">
                                ...
                                <div class="content">
                                    <h3><a href="{{ route('singleProduct', $product->slug) }}" title="{{ $product->name }}">{{ Str::words($product->name, 2, '...') }}</a></h3>
                                    <div class="rating-product">
                                        <i class="fi flaticon-star"></i>
                                        <i class="fi flaticon-star"></i>
                                        <i class="fi flaticon-star"></i>
